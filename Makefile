...
obj-m += $(MODULE_NAME).o
$(MODULE_NAME)-objs += src/module.o src/netfilter.o src/ksc.o src/rules.o src/netlink.o src/asc.o src/prot_udp.o src/prot_tcp.o src/defs.o src/crc32.o src/fnv1a32.o
